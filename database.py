...
def get_dashboard_data() -> dict:
    ...
    return {
        ...
        "bot_config": {
            "strategy":       get_bot_config("ACTIVE_STRATEGY", "ZSCORE_MEAN_REVERSION"),
            ...
            "zscore_exit":    get_bot_config("ZSCORE_EXIT",        "0.5"),
            "zscore_stop":    get_bot_config("ZSCORE_STOP",        "3.5"),
            "hurst_thresh":   get_bot_config("HURST_THRESHOLD",    "0.45"),
            "coint_pvalue":   get_bot_config("COINT_PVALUE",       "0.99"),
            "coint_last":     get_bot_config("COINT_LAST_CHECK",   ""),
        },
